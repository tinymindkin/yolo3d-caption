...
def plot_3d_box(img, cam_to_img, ry, dimension, center):
    ...
    # ### add description
    # if description:
    #     text_position = (int((box_3d[0][0] + box_3d[2][0]) / 2), int((box_3d[0][1] + box_3d[2][1]) / 2)) 
    #     cv2.putText(img, description, text_position, cv2.FONT_HERSHEY_SIMPLEX, 0.5, cv_colors.RED.value, 2)
